...
export function Component() {
  ...
  return (
    <div ref={containerRef} className="kinetic-nav-root">
        {/* Fixed kinetic MENU trigger — overlays in the top-right alongside the main nav */}
        <div className="kinetic-menu-trigger">
                  <button role="button" aria-label="Open fullscreen menu" className="nav-close-btn" onClick={toggleMenu} style={{ pointerEvents: 'auto' }}>
            ...
            <div className="menu-content-wrapper">
              <ul className="menu-list">
                ...
                <li className="menu-list-item" data-shape="3">
                  <a href="/experience" className="nav-link w-inline-block">
                ...
                <li className="menu-list-item" data-shape="4">
                  <a href="/work" className="nav-link w-inline-block">
                    <p className="nav-link-text" data-menu-fade>Case Studies</p>
                    <div className="nav-link-hover-bg"></div>
                  </a>
                </li>
